...
__decorate([
    (0, class_validator_1.IsInt)({ message: 'Job ID must be an integer.' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Job ID is required.' }),
    (0, class_validator_1.Min)(1, { message: 'Job ID must be a positive number.' }),
